...
# Kernel Sources
git clone --depth=1 https://github.com/Wstudiawan/Parak_Karakah_android_kernel_xiaomi_sdm845 -b new21caf beryllium

git clone --depth=1 https://github.com/Wstudiawan/proton-clang WS-clang # WS-clang set as Clang Default
